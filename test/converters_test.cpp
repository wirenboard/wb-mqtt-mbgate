...
TEST_F(MQTTConvertersTest, UnsignedIntTest)
{
    ...
    TMQTTIntConverter s(TMQTTIntConverter::UNSIGNED, scale, 2), sb(TMQTTIntConverter::UNSIGNED, scale, 2, true),
        sw(TMQTTIntConverter::UNSIGNED, scale, 2, false, true), sbw(TMQTTIntConverter::UNSIGNED, scale, 2, true, true);
    TMQTTIntConverter i(TMQTTIntConverter::UNSIGNED, scale, 4), ib(TMQTTIntConverter::UNSIGNED, scale, 4, true),
        iw(TMQTTIntConverter::UNSIGNED, scale, 4, false, true), ibw(TMQTTIntConverter::UNSIGNED, scale, 4, true, true);
    TMQTTIntConverter l(TMQTTIntConverter::UNSIGNED, scale, 8), lb(TMQTTIntConverter::UNSIGNED, scale, 8, true),
        lw(TMQTTIntConverter::UNSIGNED, scale, 8, false, true), lbw(TMQTTIntConverter::UNSIGNED, scale, 8, true, true);
...
TEST_F(MQTTConvertersTest, SignedIntTest)
{
    ...
    TMQTTIntConverter s(TMQTTIntConverter::SIGNED, scale, 2), sb(TMQTTIntConverter::SIGNED, scale, 2, true),
        sw(TMQTTIntConverter::SIGNED, scale, 2, false, true), sbw(TMQTTIntConverter::SIGNED, scale, 2, true, true);
    TMQTTIntConverter i(TMQTTIntConverter::SIGNED, scale, 4), ib(TMQTTIntConverter::SIGNED, scale, 4, true),
        iw(TMQTTIntConverter::SIGNED, scale, 4, false, true), ibw(TMQTTIntConverter::SIGNED, scale, 4, true, true);
    TMQTTIntConverter l(TMQTTIntConverter::SIGNED, scale, 8), lb(TMQTTIntConverter::SIGNED, scale, 8, true),
        lw(TMQTTIntConverter::SIGNED, scale, 8, false, true), lbw(TMQTTIntConverter::SIGNED, scale, 8, true, true);
...
TEST_F(MQTTConvertersTest, BcdTest)
{
    ...
    TMQTTIntConverter s(TMQTTIntConverter::BCD, scale, 2), sb(TMQTTIntConverter::BCD, scale, 2, true),
        sw(TMQTTIntConverter::BCD, scale, 2, false, true), sbw(TMQTTIntConverter::BCD, scale, 2, true, true);
    TMQTTIntConverter i(TMQTTIntConverter::BCD, scale, 4), ib(TMQTTIntConverter::BCD, scale, 4, true),
        iw(TMQTTIntConverter::BCD, scale, 4, false, true), ibw(TMQTTIntConverter::BCD, scale, 4, true, true);
    TMQTTIntConverter l(TMQTTIntConverter::BCD, scale, 8), lb(TMQTTIntConverter::BCD, scale, 8, true),
        lw(TMQTTIntConverter::BCD, scale, 8, false, true), lbw(TMQTTIntConverter::BCD, scale, 8, true, true);
